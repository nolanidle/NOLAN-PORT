...
const fileSystem: Record<string, string> = {
  "skills.txt": "Systems Programming, CPU Architecture, React/Next.js, Python, etc.\n",
  "about.txt": "Nolan Idle\n15yo Developer & Problem Solver\nMaple Grove, MN\n",
  "contact.txt": "Email: nolan@nolan.astroyds.com\nGitHub: @nolanidle\n"
};
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 md:bottom-6 right-6 z-[99999] w-[90vw] md:w-[600px] h-[400px] bg-warm backdrop-blur-md border border-border/20 shadow-2xl flex flex-col font-mono text-sm overflow-hidden text-ink"
          >
            {/* Top Bar */}
            <div className="bg-paper border-b border-border/20 p-3 flex justify-between items-center select-none text-white">
